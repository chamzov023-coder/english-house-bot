...
дети учатся воспринимать английский язык на слух,
играть и петь песенки на английском языке""",

    'kids_6_10': """🇬🇧 1 ступень - I can speak
дети начинают бегло говорить по-английски,
используя около 250 слов""",

    'teens': """🇬🇧 Английский для подростков
подготовка к ОГЭ, ЕГЭ только после прохождения предыдущих курсов.

Подростки, которые не сдают экзамены,
занимаются по программе "Взрослые" — для общения.""",
...
def handle_text(message):
    ...
    if text == "📝 Записаться":
        ...
        user_data[chat_id] = {
            "state": "name",
            "age_group": "Онлайн обучение",
            "program": "Онлайн занятия",
            "schedule": "Нужно связаться с клиентом"
        }
...
- Проводит подготовку и стажировку учителей английского языка.

- Помогает детям и взрослым заговорить на английском языке. Это возможно и это реально.

- Работаем по эмпирической системе I Love English.
